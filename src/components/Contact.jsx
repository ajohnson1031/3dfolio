...
const Contact = () => {
  ...
  const handleMessage = (message, isErr = false) => {
    setMessage(message);
    setMessageClassName(!isErr ? "text-green-300" : "text-red-400");
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "aaron.johnson1031@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          handleMessage("Thank you. I will get back to you as soon as possible.");
        ...
        (error) => {
          ...
          handleMessage("Ahh, something went wrong. Please try again.", true);
        }
      );
  };
